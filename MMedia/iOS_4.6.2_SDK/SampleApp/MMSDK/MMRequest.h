...
//  MMSDK
//
//  Created by Mike Patzer on 8/22/12.
...
// Creates a generic autoreleased MMRequest
+ (MMRequest *)request;

#pragma mark - Location Information

// Creates an autorelease MMRequest with location
...
@property(nonatomic,strong,readonly) NSMutableDictionary *dataParameters;
