...
In order to follow this guide, you must have the iOS 4.3 SDK and Xcode 4.2 installed on your system. For the latest versions, please visit Apple's iOS Dev Center (http://developer.apple.com/devcenter/ios/).

**Run time requirements**

The minimum iOS version supported by the SDK is iOS 4.3.
