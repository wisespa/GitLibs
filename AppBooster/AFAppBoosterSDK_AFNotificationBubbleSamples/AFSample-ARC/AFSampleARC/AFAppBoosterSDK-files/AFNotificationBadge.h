/*
 AFNotificationBadge.h refactored from CustomBadge.h
...
@interface AFNotificationBadge : UIView
{	
	NSString *badgeText;
...
@property(nonatomic,readwrite) CGSize  badgeBaseSize;
