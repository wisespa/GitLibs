...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        // images
        _bubbleEmpty = [UIImage imageNamed:kAFNotificationBubbleImageDisabled];
        _bubbleRed   = [UIImage imageNamed:kAFNotificationBubbleImageEnabled];
        ...
        // label
        _labelNotificationsNumber = [[UILabel alloc] initWithFrame:CGRectMake(0, 0,
                                                                              kAFNotificationBubbleWidth,
                                                                              kAFNotificationLabelHeight)];
